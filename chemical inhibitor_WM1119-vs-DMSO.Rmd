...
res_unshrunken <- results(dds, name="Drug_WM1119_vs_DMSO")
...
```{r}
gencode_genes<-read.csv("C:\\Users\\leall\\Downloads\\gencode.v31.primary_assembly.genes.csv")
...
hcng_ref<-read.delim("C:\\Users\\leall\\Downloads\\HCNG_05-09-19.txt")
